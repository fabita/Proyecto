 ...
 * @author FABIOLA
 */
public class LlenarTablaAditivos {
    DefaultTableModel model;
    BDConexion bd = new BDConexion();
    Connection cn = bd.conexion();

     public void llenar_tabla_Aditivos(int numCol,int columBoolean,DefaultTableModel modelo, JTable tabla){
        try{String query="select aditivos.producto, aditivos.precio, ope_aditivos.cantidad from aditivos, ope_aditivos";
            ResultSet rs;
